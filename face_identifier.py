...
class Identifier(object):
    ...
    cascadePath = "haarcascade_frontalface_default2.xml"
    face_detector = cv2.CascadeClassifier(cascadePath)
    font = cv2.FONT_HERSHEY_SIMPLEX

    training_data = "training_data/trainer.yml"
    ...
    def image_loop(self):
        ...
        identifier = cv2.face.LBPHFaceRecognizer_create(1, 8, 8, 8, 123)
        identifier.read(self.training_data)
        ...
        for i, im in enumerate(self.vid_cam):
            ...
            for (x,y,w,h) in faces:
                ...
                cv2.putText(image, str(Id), (x,y-40), self.font, 1, (255,255,255), 2)
